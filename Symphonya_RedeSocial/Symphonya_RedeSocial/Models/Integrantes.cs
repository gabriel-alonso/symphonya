...
namespace Symphonya_RedeSocial.Models
{
    public class Integrantes
    {
        ...
        public static List<Integrantes> ListarIntegrantes(Int32 ID)
        {
            ...
            Comando.CommandText = "SELECT DISTINCT Usuario.ID, Usuario.Nome, Usuario.Sobrenome, Usuario.Email FROM Usuario_Has_Bandas, Bandas, Usuario WHERE BandasID = @ID AND UsuarioID = Usuario.ID;";
